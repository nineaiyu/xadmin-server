...
from movies.libs.alidrive.types.Enum import *
...
class File(Core):
    ...
    def get_file(self, body: GetFileRequest) -> BaseFile:
        ...
        用法示例:
        >>> from movies.libs.alidrive import Aligo, BaseFile, GetFileRequest
        >>> ali = Aligo()
    ...
    def get_file_list(self, body: GetFileListRequest) -> List[BaseFile]:
        ...
        用法示例:
        >>> from movies.libs.alidrive import Aligo, BaseFile, GetFileListRequest
        >>> ali = Aligo()
    ...
    def batch_get_files(self, file_id_list: List[str], drive_id: str = None) -> List[BaseFile]:
        ...
        用法示例:
        >>> from movies.libs.alidrive import Aligo, Null
        >>> ali = Aligo()
