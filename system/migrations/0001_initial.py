# Generated by Django 5.0.7 on 2024-07-30 06:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(0, 'Unknown'), (1, 'Male'), (2, 'Female')], default=0,
                                               verbose_name='Gender')),
                ('mobile', models.CharField(blank=True, default='', max_length=16, verbose_name='Mobile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               related_name='+', related_query_name='modifier_query',
                                               to=settings.AUTH_USER_MODEL, verbose_name='Modifier')),
                ('notice_dept', models.ManyToManyField(blank=True, null=True, to='system.deptinfo',
                                                       verbose_name='The notified department')),
            ],
            options={
                'verbose_name': 'Notice message',
                'verbose_name_plural': 'Notice message',
                'ordering': ('-created_time',),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'User has read the message',
                'verbose_name_plural': 'User has read the message',
                'ordering': ('-created_time',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='Updated time')),
                ('description', models.CharField(blank=True, max_length=256, null=True, verbose_name='Description')),
                ('value', models.TextField(max_length=10240, verbose_name='Config value')),
                ('is_active', models.BooleanField(default=True, verbose_name='Is active')),
