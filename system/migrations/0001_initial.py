    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode_type', models.SmallIntegerField(choices=[(0, '或模式'), (1, '且模式')], default=0,
                                                       help_text='权限模式, 且模式表示数据需要同时满足规则列表中的每条规则，或模式即满足任意一条规则即可',
                                                       verbose_name='数据权限模式')),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='数据权限名称')),
                ('rules', models.JSONField(max_length=512, verbose_name='规则')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.IntegerField(default=99, verbose_name='排序')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('path', models.CharField(max_length=255, verbose_name='路由地址 或 后端权限路由')),
        ...
        migrations.AddField(
            model_name='datapermission',
            name='menu',
            field=models.ManyToManyField(blank=True, help_text='若存在菜单权限，则该权限仅针对所选择的菜单权限生效',
                                         null=True, to='system.menu', verbose_name='权限菜单'),
        ),
        migrations.CreateModel(
            name='MenuMeta',
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
                ('description', models.CharField(blank=True, max_length=256, null=True, verbose_name='描述信息')),
                ('title', models.CharField(blank=True, max_length=255, null=True, verbose_name='菜单名称')),
                ...
                ('r_svg_name', models.CharField(blank=True, help_text='菜单右侧额外图标iconfont名称，目前只支持iconfont',
                                                max_length=255, null=True, verbose_name='菜单右侧额外图标')),
                ...
                ('frame_url',
                 models.CharField(blank=True, max_length=255, null=True, verbose_name='内嵌的iframe链接地址')),
                ('frame_loading',
                 models.BooleanField(default=False, verbose_name='内嵌的iframe页面是否开启首次加载动画')),
                ('transition_enter',
                 models.CharField(blank=True, max_length=255, null=True, verbose_name='当前页面进场动画')),
                ('transition_leave',
                 models.CharField(blank=True, max_length=255, null=True, verbose_name='当前页面离场动画')),
                ('is_hidden_tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE,
                                             to='system.modellabelfield', verbose_name='上级节点')),
            ],
            options={
                'verbose_name': '模型字段',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modifier', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                               ...
                                               to=settings.AUTH_USER_MODEL, verbose_name='修改人')),
                ('notice_dept',
                 models.ManyToManyField(blank=True, null=True, to='system.deptinfo', verbose_name='通知的部门')),
            ],
            options={
                'verbose_name': '消息通知',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, null=True, through='system.NoticeUserRead',
                                         to=settings.AUTH_USER_MODEL, verbose_name='通知的用户'),
        ),
        migrations.CreateModel(
            name='OperationLog',
            fields=[
                ...
                ('browser', models.CharField(blank=True, max_length=64, null=True, verbose_name='浏览器')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=True, verbose_name='状态')),
                ('access',
                 models.BooleanField(default=False, help_text='允许API接口访问该配置', verbose_name='接口访问')),
                ('key', models.CharField(max_length=255, unique=True, verbose_name='配置名称')),
                (
                'inherit', models.BooleanField(default=False, help_text='允许用户继承该配置', verbose_name='用户继承')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              related_name='+', related_query_name='creator_query',
                                              to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('dept_belong', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filepath', models.FileField(blank=True, null=True, upload_to=common.core.models.upload_directory_path,
                                              verbose_name='文件存储')),
                ('file_url',
                 models.URLField(blank=True, help_text='一般为外部互联网可以访问的地址', max_length=255, null=True,
                                 verbose_name='外部地址')),
                ...
                ('is_tmp',
                 models.BooleanField(default=False, help_text='临时文件会被定时任务自动清理', verbose_name='临时文件')),
                ('is_upload', models.BooleanField(default=False, verbose_name='上传文件')),
                ('creator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                              related_name='+', related_query_name='creator_query',
                                              to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
                ('dept_belong', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
        ...
        migrations.AddField(
            model_name='noticemessage',
            name='notice_role',
            field=models.ManyToManyField(blank=True, null=True, to='system.userrole', verbose_name='通知的角色'),
        ),
        migrations.AddField(
            model_name='deptinfo',
            name='roles',
