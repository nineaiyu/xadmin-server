# -*- coding: utf-8 -*-
"""U-1 审批决策信息完备：目标对象快照 / 关联业务对象卡片 / 处理人显示名快照。
...
class TestTargetSnapshot:
    ...
    def test_patch_style_changes_diff_rendered(self):
        ...
        from system.utils.approval.snapshot import build_target_snapshot
...
class TestAssigneeSnapshot:
    def test_node_task_and_actor_display(self, superuser, approver):
        from system.utils.approval_flow.engine import _enter_node, approve_task
