...
class AiActionExecuteMixin:
    ...
    def action_interpret_stream(self, request, *args, **kwargs):
        ...
        from ai.utils.ai_actions import (
            ai_action_enabled,
            audit_ai_action,
            build_draft_prompt,
            draft_summary,
    ...
    def action_execute(self, request, *args, **kwargs):
        ...
        from ai.utils.ai_actions import ai_action_enabled, audit_ai_action, execute_action, get_action
        from ai.utils.ai_idempotency import execute_idempotent
