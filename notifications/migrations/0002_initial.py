...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='systemmsgsubscription',
            name='groups',
            field=models.ManyToManyField(related_name='system_msg_subscriptions', to='system.deptinfo'),
        ),
        migrations.AddField(
            model_name='systemmsgsubscription',
            name='modifier',
        ...
        migrations.AddField(
            model_name='usermsgsubscription',
            name='user',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='user_msg_subscription', to=settings.AUTH_USER_MODEL, verbose_name='User'),
        ),
        migrations.AddIndex(
            model_name='messageuserread',
