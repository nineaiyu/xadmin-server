...
ALLOWED_TAGS = [
    'a', 'abbr', 'b', 'blockquote', 'br', 'code', 'col', 'colgroup', 'del', 'div', 'em',
    'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'hr', 'i', 'img', 'ins', 'li', 'mark', 'ol', 'p',
    'pre', 'q', 's', 'small', 'span', 'strong', 'sub', 'sup', 'table', 'tbody', 'td', 'th',
    'thead', 'tr', 'u', 'ul', 'video', 'source',
]
ALLOWED_ATTRS = {
    '*': ['class', 'style'],
...
ALLOWED_CSS_PROPERTIES = [
    'background-color', 'border', 'border-collapse', 'border-color', 'border-radius',
    'border-style', 'border-width', 'bottom', 'clear', 'color', 'display', 'float',
    ...
    'max-width', 'min-height', 'min-width', 'overflow', 'padding', 'padding-bottom',
